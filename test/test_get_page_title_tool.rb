...
class TestGetPageTitleTool < Minitest::Test
  ...
  def test_tool_has_execute_method
    assert HeadlessBrowserTool::Tools::GetPageTitleTool.method_defined?(:execute)
  end

  def test_tool_registration
    all_tool_names = HeadlessBrowserTool::Tools::ALL_TOOLS.map(&:tool_name)

    assert_includes all_tool_names, "get_page_title"
  end
end
