...
class TestMCPProtocolIntegration < Minitest::Test
  ...
  def test_mcp_stdio_protocol_call_method
    ...
    assert_predicate response_lines, :any?, "Server failed to return valid JSON response. Error: #{error}"
    ...
    assert_match(%r{url.*https://www\.example\.com}, text_content)
